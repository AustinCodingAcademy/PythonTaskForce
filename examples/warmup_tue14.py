...
class Person:
    ...
    def can_afford(self, order_totals):

        if self.bank_balance >= order_totals:
            return True
        else:
            return False
...
class Order:
    ...
    def add_product(self, new_product):
        return self.listOfProducts.append(new_product)



if __name__ == "__main__":

    shopper = Person(name='Samir', age=30, street_address='5421 Hickory Dr', bank_balance=10000)

    if shopper.can_afford(order_totals=2500):
